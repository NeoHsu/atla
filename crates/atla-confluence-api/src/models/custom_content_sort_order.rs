...
pub enum CustomContentSortOrder {
    #[serde(rename = "id")]
    Id,
    #[serde(rename = "-id")]
    Id2,
...
impl std::fmt::Display for CustomContentSortOrder {
...
impl Default for CustomContentSortOrder {
    fn default() -> CustomContentSortOrder {
        Self::Id
    }
}
