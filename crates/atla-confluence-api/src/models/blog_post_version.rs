...
pub struct BlogPostVersion {
    ...
    #[serde(rename = "blogpost", skip_serializing_if = "Option::is_none")]
    pub blogpost: Option<Box<models::VersionedEntity>>,
}

impl BlogPostVersion {
    pub fn new() -> BlogPostVersion {
        BlogPostVersion {
            created_at: None,
            message: None,
            number: None,
