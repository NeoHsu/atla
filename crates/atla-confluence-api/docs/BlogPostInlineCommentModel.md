...
**blog_post_id** | Option<**String**> | ID of the blog post the comment is in. | [optional]
...
**properties** | Option<[**models::InlineCommentProperties**](InlineCommentProperties.md)> |  | [optional]
