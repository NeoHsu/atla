pub(in crate::commands::confluence) fn open_web_url(url: &str) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_search_results(
...
pub(in crate::commands::confluence) fn search_title(result: &ConfluenceSearchResult) -> &str {
    result
        .title
        .as_deref()
        .or_else(|| {
...
pub(in crate::commands::confluence) fn print_attachment(
...
pub(in crate::commands::confluence) fn attachment_version(
    attachment: &ConfluenceAttachment,
) -> Option<String> {
    attachment
        .version
...
pub(in crate::commands::confluence) fn print_attachments(
...
pub(in crate::commands::confluence) fn print_attachments_with_footer(
    attachments: &[ConfluenceAttachment],
    global: &Invocation,
    footer: Option<String>,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_attachment_download(
    path: &str,
    bytes: u64,
    global: &Invocation,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_deleted(
    kind: &str,
    id: &str,
    global: &Invocation,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_labels(
...
pub(in crate::commands::confluence) fn print_labels_with_footer(
    page: &ConfluenceLabelPage,
    global: &Invocation,
    footer: Option<String>,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_comments(
...
pub(in crate::commands::confluence) fn print_comments_with_footer(
    page: &ConfluenceCommentPage,
    global: &Invocation,
    footer: Option<String>,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_comment(
...
pub(in crate::commands::confluence) fn comment_version(
    comment: &ConfluenceComment,
) -> Option<String> {
    comment
        .version
...
pub(in crate::commands::confluence) fn print_content_nodes(
...
pub(in crate::commands::confluence) fn print_content_nodes_with_footer(
    nodes: &[ConfluenceContentNode],
    global: &Invocation,
    footer: Option<String>,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_pages(
...
pub(in crate::commands::confluence) fn print_pages_with_footer(
    pages: &[ConfluencePage],
    global: &Invocation,
    footer: Option<String>,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_page_with_attachments(
    page: &ConfluencePage,
    attachments: &[ConfluenceAttachment],
    global: &Invocation,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_page(
    page: &ConfluencePage,
    global: &Invocation,
) -> anyhow::Result<()> {
    match global.output.unwrap_or(OutputFormat::Table) {
...
pub(in crate::commands::confluence) fn page_version(page: &ConfluencePage) -> Option<String> {
    page.version
        .as_ref()
        .and_then(|version| version.number)
        .map(|number| number.to_string())
...
pub(in crate::commands::confluence) fn print_blog_posts(
...
pub(in crate::commands::confluence) fn print_blog_posts_with_footer(
    posts: &[ConfluenceBlogPost],
    global: &Invocation,
    footer: Option<String>,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_blog_post(
...
pub(in crate::commands::confluence) fn blog_post_version(
    post: &ConfluenceBlogPost,
) -> Option<String> {
    post.version
        .as_ref()
...
pub(in crate::commands::confluence) fn print_spaces(
...
pub(in crate::commands::confluence) fn print_spaces_with_footer(
    spaces: &[ConfluenceSpace],
    global: &Invocation,
    footer: Option<String>,
) -> anyhow::Result<()> {
...
pub(in crate::commands::confluence) fn print_space(
