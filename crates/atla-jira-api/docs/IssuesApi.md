...
> models::CreatedIssue create_issue(issue_update_details)
Create issue
...
> do_transition(issue_id_or_key, issue_transition_request)
Transition issue
...
**issue_transition_request** | [**IssueTransitionRequest**](IssueTransitionRequest.md) |  | [required] |
...
> edit_issue(issue_id_or_key, issue_update_details)
Edit issue
