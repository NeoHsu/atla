...
reported privately to [the repository maintainer][maintainer] using a private
contact method listed on the maintainer's GitHub profile. If no private contact
method is available, or if the report concerns the maintainer, use GitHub's
...
[maintainer]: https://github.com/NeoHsu
