...
| --- | --- | --- | --- | --- |
| `doctor` | none | `--network`, `--skill-version` | Report local configuration and optionally verify exact CLI/skill compatibility or tenant discovery. | `atla doctor --skill-version 0.6.1 --output json` |
